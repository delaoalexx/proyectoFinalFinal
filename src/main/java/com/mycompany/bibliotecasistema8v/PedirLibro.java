...
public class PedirLibro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Ingrese el ISBN del libro a solicitar");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        boolean exito = libroDAO.pedirLibro(isbn);
        if (exito) {   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedirLibro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PedirLibro().setVisible(true);
            }
        });
    }
